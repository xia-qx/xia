package org.xia.common.mybatis.handler;
...
import org.xia.common.core.domain.dto.RoleDTO;
import org.xia.common.core.domain.model.LoginUser;
import org.xia.common.core.exception.ServiceException;
import org.xia.common.core.utils.SpringUtils;
import org.xia.common.core.utils.StreamUtils;
import org.xia.common.core.utils.StringUtils;
import org.xia.common.mybatis.annotation.DataColumn;
import org.xia.common.mybatis.annotation.DataPermission;
import org.xia.common.mybatis.enums.DataScopeType;
import org.xia.common.mybatis.helper.DataPermissionHelper;
import org.xia.common.satoken.utils.LoginHelper;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/Xia/issues/IB4CS4
